...
SRC_PE      = ROOT / "outputs/generated/tables/econometrics"
SRC_REIT    = ROOT / "outputs/generated/tables/econometrics_reit"
OUT_PE      = ROOT / "outputs/generated/final/pe/tables"
OUT_REIT    = ROOT / "outputs/generated/final/reit/tables"

PDFLATEX = shutil.which("pdflatex")
PDFTOPPM = shutil.which("pdftoppm")

OUT_PE.mkdir(parents=True, exist_ok=True)
OUT_REIT.mkdir(parents=True, exist_ok=True)

if PDFLATEX is None:
    print("pdflatex is not installed; skipping PDF/PNG table rendering.")
    raise SystemExit(0)
...
def compile_table(
    ...
    with tempfile.TemporaryDirectory() as tmp:
        ...
        elif PDFTOPPM is None:
            print(f"  ✓ {stem}.pdf  (pdftoppm not installed; skipped PNG)")
        else:
