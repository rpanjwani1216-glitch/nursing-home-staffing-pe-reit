...
log using "${QA_DIR}/run_star_rating_econometrics_gold_plus_silver.log", replace text
...
tempname coefpost
postfile `coefpost' str12 panel str24 outcome double coef se lb ub long N using "${TABLES_DIR}/paper_star_main_coef_plot_data_gold_plus_silver.dta", replace
...
use "${TABLES_DIR}/paper_star_main_coef_plot_data_gold_plus_silver.dta", clear
export delimited using "${TABLES_DIR}/paper_star_main_coef_plot_data_gold_plus_silver.csv", replace

_esttab_export_pair ///
    star_health_main_nat star_health_main_state star_health_main_match, ///
    stem(star_main_health_rating_gold_plus_silver) ///
...
_esttab_export_pair ///
    ...
    stem(star_main_overall_rating_gold_plus_silver) ///
...
_esttab_export_pair ///
    ...
    stem(star_main_staffing_rating_gold_plus_silver) ///
...
_esttab_export_pair ///
    ...
    stem(star_main_qm_rating_gold_plus_silver) ///
